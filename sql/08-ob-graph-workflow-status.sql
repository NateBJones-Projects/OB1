-- OB-Graph Knowledge Graph + Workflow Status Schema
-- Combined schema for Open Brain v2 setup
-- Run this entire file in your Supabase SQL Editor

-- ============================================================================
-- OB-GRAPH: Knowledge Graph Tables and Functions
-- ============================================================================
...
-- OB-Graph Trigger for auto-update updated_at
...
-- OB-Graph Function: traverse_graph
...
-- OB-Graph Function: find_shortest_path
...
-- OB-Graph Grant permissions to service_role
...
-- ============================================================================
-- WORKFLOW STATUS: Kanban-style Task Management
-- ============================================================================

-- Add status column to thoughts table (nullable — only task/idea types use it)
...
-- Note: 'type' lives inside metadata JSONB, not as a top-level column
UPDATE thoughts
