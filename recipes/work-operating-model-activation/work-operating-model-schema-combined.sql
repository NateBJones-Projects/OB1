-- ============================================
-- Work Operating Model Activation - Combined Schema
-- ============================================
-- Run this in your Supabase SQL Editor to set up the complete schema
-- ============================================

-- First, generate your default user ID:
-- Run: uuidgen | tr '[:upper:]' '[:lower:]'
-- Then set it as a secret: supabase secrets set DEFAULT_USER_ID=your-generated-uuid
